 ...
 * Use the [SummarisePreviousMilestoneFragment.newInstance] factory method to
...
class SummarisePreviousMilestoneFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SummarisePreviousMilestoneFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SummarisePreviousMilestoneFragment().apply {
